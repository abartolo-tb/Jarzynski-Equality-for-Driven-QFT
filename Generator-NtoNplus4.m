...
myIntegrand[W_,\[Beta]_,q1_,q2_,q3_,t1_,t2_,phi_]:=Boole[W-4>=0]*Boole[q3>10^-50]*Boole[ Abs[W-Sqrt[1+q1^2]-Sqrt[1+q2^2]-Sqrt[1+q3^2]-Sqrt[1+q1^2+q2^2+2q1 q2 (Sin[t1]Sin[t2]Cos[phi]+Cos[t1]Cos[t2])+2q1 q3 Cos[t1]+2q2 q3 Cos[t2]+q3^2]]<= 10^-2]*1/Max[Abs[q3(W- Omega[q1]-Omega[q2])+(q1 Cos[t1]+ q2 Cos[t2])Omega[q3]],10^-100]*(1+1/Max[Abs[Exp[\[Beta] (W- Omega[q1]-Omega[q2]-Omega[q3])]-1],10^-100])*(1+1/(Exp[\[Beta] Omega[q1]]-1))(1+1/(Exp[\[Beta] Omega[q2]]-1))(1+1/(Exp[\[Beta] Omega[q3]]-1))*(q1^2 q2^2 q3^2 Sin[t1]Sin[t2])/(2Omega[q1]2Omega[q2])*1/4!*(2Pi^2)/(2Pi)^9
...
workPoint[W_,\[Beta]_]:=2*NIntegrate[momentumSubspaceInterpolation[W,\[Beta]][q1,q2],{q1,0,Sqrt[(W-3)^2-1]},{q2,0,q1},PrecisionGoal->6,AccuracyGoal->20]
...
CloseKernels[];
Export["/path/NtoNplus4dist-B01.m",distributionB01];
...
CloseKernels[];
Export["/path/NtoNplus4dist-B02.m",distributionB02];
...
CloseKernels[];
Export["/path/NtoNplus4dist-B03.m",distributionB03];
...
CloseKernels[];
Export["/path/NtoNplus4dist-B04.m",distributionB04];
...
CloseKernels[];
Export["/path/NtoNplus4dist-B05.m",distributionB05];
...
CloseKernels[];
Export["/path/NtoNplus4dist-B06.m",distributionB06];
...
CloseKernels[];
Export["/path/NtoNplus4dist-B07.m",distributionB07];
...
CloseKernels[];
Export["/path/NtoNplus4dist-B08.m",distributionB08];
...
CloseKernels[];
Export["/path/NtoNplus4dist-B09.m",distributionB09];
...
CloseKernels[];
Export["/path/NtoNplus4dist-B10.m",distributionB10];
...
CloseKernels[];
Export["/path/NtoNplus4dist-B11.m",distributionB11];
...
CloseKernels[];
Export["/path/NtoNplus4dist-B12.m",distributionB12];
...
CloseKernels[];
Export["/path/NtoNplus4dist-B13.m",distributionB13];
...
CloseKernels[];
Export["/path/NtoNplus4dist-B14.m",distributionB14];
...
CloseKernels[];
Export["/path/NtoNplus4dist-B15.m",distributionB15];
...
CloseKernels[];
Export["/path/NtoNplus4dist-B16.m",distributionB16];
...
CloseKernels[];
Export["/path/NtoNplus4dist-B17.m",distributionB17];
...
CloseKernels[];
Export["/path/NtoNplus4dist-B18.m",distributionB18];
...
CloseKernels[];
Export["/path/NtoNplus4dist-B19.m",distributionB19];
